(function () {
  ...
  const translations = {
    en: {
      ...
      sd_intro: "Beyond composition, I design and implement audio: the interactive, reactive soundscapes that make a game world feel alive. Using middleware like Wwise, I integrate sound effects and music straight into the engine so the audio responds to the player in real time.",
      sd_card1_title: "Wwise & Middleware",
      sd_card1_text: "Hands-on experience integrating audio through middleware like Wwise, connecting sound to game logic and events.",
      sd_card2_title: "Audio Implementation",
      sd_card2_text: "Getting sound out of the DAW and into the engine — states, switches, RTPCs and event triggers wired to gameplay.",
      sd_card3_title: "Interactive & Adaptive Audio",
      sd_card3_text: "Music and ambience that shift with the action, reacting to what the player does moment to moment.",
      sd_card4_title: "Sound Effects",
      sd_card4_text: "Designing and layering SFX that feel tactile, readable and true to each world.",
      // Index — Audiovisual
...
Mi rol aqui fue componer la música para el documental de 38 minutos.`,
      ...
      step1_title: "Cuentame de tu proyecto",
